...
<html lang="en">
  <head>
    ...
    <title>Car Parking management Portal</title>
    <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body>
    <div >
      <div class="container">
         ...
         <div class="col-md-8">
                 <center><h1 class="colors"><a href="home.php" style="text-decoration: none; color:white;">PARKING PORTAL</a></h1></center>
           ...
           <ul>
             ...
             <li class="list-group-item">
               <select class="form-control" onchange="filter_park()" id="street">
                 ...
                 <option value="Rental_Colony">Rental_Colony</option>
                 <option value="Dumduma">Dumduma</option>
                 <option value="Kalinga_bihar">Kalinga_bihar</option>
                 <option value="Busstand">Busstand</option>
               </select>
             </li>

             <li class="list-group-item" id="requests"><a><span class="glyphicon glyphicon-envelope"></span> _Any Issue <br> Feel Free to contact us. <br> Contact Details: <br>D-17/6, Rental Colony <br>
            P.O-IRC Village<br> Bhubaneswar,Odisha<br>PHno.-987654321<br>email-carparkingmanagementsystem@gmail.com</a></li>
